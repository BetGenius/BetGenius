...
This document provides guidelines for internationalization of the BetGenius Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `betgenius_en.ts` remains unchanged.
