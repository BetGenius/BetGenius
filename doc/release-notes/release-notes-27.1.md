BetGenius Core version 27.0 is now available from:

  <https://betgenius.cc/bin/betgenius-core-27.0/>
...
- A C++20 capable compiler is now required to build BetGenius Core. (#28349)
...
- Various fixes to prevent issues where subsequent instances of BetGenius Core would
