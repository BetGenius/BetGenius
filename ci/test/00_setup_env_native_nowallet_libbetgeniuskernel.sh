...
export CONTAINER_NAME=ci_native_nowallet_libbetgeniuskernel
...
export GOAL="install"
export BETGENIUS_CONFIG="--enable-reduce-exports --enable-experimental-util-chainstate --with-experimental-kernel-lib --enable-shared"
