...
"""Test framework for betgenius utils.
...
def main():
    ...
    bctester(os.path.join(env_conf["SRCDIR"], "test", "util", "data"), "betgenius-util-test.json", env_conf)
...
def bctest(testDir, testObj, buildenv):
    ...
    if testObj["exec"] == "./betgenius-util":
        execprog = os.getenv("BETGENIUSUTIL", default=execprog)
    elif testObj["exec"] == "./betgenius-tx":
        execprog = os.getenv("BETGENIUSTX", default=execprog)
    ...
    if "error_txt" in testObj:
        ...
        # That stderr is empty if no errors are expected. However, betgenius-tx
