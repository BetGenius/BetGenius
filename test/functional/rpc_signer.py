...
Verify that a betgeniusd node can use an external signer command.
...
class RPCSignerTest(BetGeniusTestFramework):
    ...
    def run_test(self):
        ...
        assert_raises_rpc_error(-1, 'Error: restart betgeniusd with -signer=<cmd>',
