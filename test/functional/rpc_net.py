...
class NetTest(BetGeniusTestFramework):
    ...
    def test_getnodeaddresses(self):
        ...
        self.nodes[0].addpeeraddress(address=ipv6_addr, port=5870)
        ...
        for i in range(10000):
            ...
            self.nodes[0].addpeeraddress(a, 5870)
    ...
    def test_addpeeraddress(self):
        ...
        assert_equal(node.addpeeraddress(address="", port=5870), {"success": False})
