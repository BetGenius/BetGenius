...
class CreateWalletTest(BetGeniusTestFramework):
    ...
    def run_test(self):
        ...
        assert_equal(resp["warnings"], [EMPTY_PASSPHRASE_MSG] if self.options.descriptors else [EMPTY_PASSPHRASE_MSG])
