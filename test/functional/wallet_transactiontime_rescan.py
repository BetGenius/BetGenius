...
class TransactionTimeRescanTest(BetGeniusTestFramework):
    ...
    def run_test(self):
        ...
        minernode = self.nodes[0]  # node used to mine BETG and create transactions
        ...
        # generate some betg to create transactions and check blockcount
        ...
        # send 10 betg to user's first watch-only address
        self.log.info('Send 10 betg to user')
        ...
        # send 5 betg to our second watch-only address
        self.log.info('Send 5 betg to user')
        ...
        # send 1 betg to our third watch-only address
        self.log.info('Send 1 betg to user')
