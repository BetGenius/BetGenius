...
class TestShell:
    """Wrapper Class for BetGeniusTestFramework.

    The TestShell class extends the BetGeniusTestFramework
    ...
    class __TestShell(BetGeniusTestFramework):
        ...
        def setup(self, **kwargs):
            ...
            # by BetGeniusTestFramework child class.
            self.num_nodes = 1
