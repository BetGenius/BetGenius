...
"""Verify that starting betgenius with -h works as expected."""

from test_framework.test_framework import BetGeniusTestFramework
from test_framework.util import assert_equal

class HelpTest(BetGeniusTestFramework):
    ...
    def run_test(self):
        self.log.info("Start betgenius with -h for help text")
        ...
        self.log.info("Start betgenius with -version for version information")
        ...
        self.log.info("Start betgeniusd with -fakearg to make sure it does not start")
