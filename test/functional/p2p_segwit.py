...
class SegWitTest(BetGeniusTestFramework):
    def set_test_params(self):
        self.setup_clean_chain = True
        self.num_nodes = 2
        # This test tests SegWit both pre and post-activation, so use the normal BIP9 activation.
        self.extra_args = [
            ["-acceptnonstdtxn=1", "-whitelist=noban@127.0.0.1", "-par=1"],
            ["-acceptnonstdtxn=0",],
        ]
    ...
    def test_p2sh_witness(self):
        ...
        # segwit activation.  Note that older betgeniusd's that are not
    ...
    def test_submit_block(self):
        ...
        # Now redo commitment with the standard nonce, but let betgeniusd fill it in.
