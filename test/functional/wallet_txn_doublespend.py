...
class TxnMallTest(BetGeniusTestFramework):
    ...
    def run_test(self):
        # All nodes should start with 1,250 BETG:
        ...
        # First: use raw transaction API to send 1240 BETG to node1_address,
        # but don't broadcast:
        ...
        # Create two spends using 1 50 BETG coin each
        ...
        # Node0's balance should be starting balance, plus 50BETG for another
        ...
        # Node0's total balance should be starting balance, plus 100BETG for
