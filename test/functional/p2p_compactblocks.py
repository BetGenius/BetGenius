...
# TestP2PConn: A peer we use to send messages to betgeniusd, and store responses.
...
class CompactBlocksTest(BetGeniusTestFramework):
    ...
    # This test actually causes betgeniusd to (reasonably!) disconnect us, so do this last.
    ...
    # Test that betgeniusd requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, test_node):
        ...
        # Note that it's possible for betgeniusd to be smart enough to know we're
    ...
    def test_getblocktxn_handler(self, test_node):
        node = self.nodes[0]
        # betgeniusd will not send blocktxn responses for blocks whose height is
