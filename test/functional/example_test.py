...
def custom_function():
    ...
    # self.log.info("running custom_function")  # Oops! Can't run self.log outside the BetGeniusTestFramework
    pass


class ExampleTest(BetGeniusTestFramework):
    # Each functional test is a subclass of the BetGeniusTestFramework class.
    ...
    def custom_method(self):
        ...
        BetGeniusTestFramework class so other tests can use it."""
