...
"""
Test starting betgeniusd with -bind and/or -bind=...=onion and confirm
...
class BindExtraTest(BetGeniusTestFramework):
    ...
    def run_test(self):
        for i in range(len(self.expected)):
            ...
            # that betgeniusd has bound on "::1" (for RPC) and "::" (for P2P).
