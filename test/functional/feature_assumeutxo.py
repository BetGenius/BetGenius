...
to a hash that has been compiled into betgeniusd.
...
class AssumeutxoTest(BetGeniusTestFramework):
    ...
    def test_invalid_mempool_state(self, dump_output_path):
        self.log.info("Test betgeniusd should fail when mempool not empty.")
        node=self.nodes[2]
