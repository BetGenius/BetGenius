...
By default, betgeniusd will dump mempool on shutdown and
...
class MempoolPersistTest(BetGeniusTestFramework):
    ...
    def run_test(self):
        ...
        self.log.debug("Prevent betgeniusd from writing mempool.dat to disk. Verify that `savemempool` fails")
