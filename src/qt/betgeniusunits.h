...
#ifndef BETGENIUS_QT_BETGENIUSUNITS_H
#define BETGENIUS_QT_BETGENIUSUNITS_H
...
/** BetGenius unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class BetGeniusUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit BetGeniusUnits(QObject *parent);

    /** BetGenius units.
      @note Source: https://en.betgenius.it/wiki/Units . Please add only sensible ones
     */
    enum class Unit {
        BETG,
        mBETG,
