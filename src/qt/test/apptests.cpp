...
//! Entry point for BetGeniusApplication tests.
void AppTests::appTests()
{
    ...
    connect(&m_app, &BetGeniusApplication::windowShown, this, &AppTests::guiTests);
...
//! Entry point for BetGeniusGUI tests.
void AppTests::guiTests(BetGeniusGUI* window)
{
    HandleCallback callback{"guiTests", *this};
    connect(window, &BetGeniusGUI::consoleShown, this, &AppTests::consoleTests);
