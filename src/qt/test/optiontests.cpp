...
{
    // Test regression https://github.com/BetGenius/BetGenius/issues/24457. Ensure
...
{
    // Test that the bug https://github.com/betgenius-core/gui/issues/567 does not resurface.
    // It was fixed via https://github.com/betgenius-core/gui/pull/568.
    // With fListen=false in ~/.config/BetGenius/BetGenius-Qt.conf and all else left as default,
    // betgenius-qt should set both -listen and -listenonion to false and start successfully.
