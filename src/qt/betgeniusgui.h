...
#ifndef BETGENIUS_QT_BETGENIUSGUI_H
#define BETGENIUS_QT_BETGENIUSGUI_H
...
/**
  BetGenius GUI main class. This class represents the main window of the BetGenius UI. It communicates with both the client and
  wallet models to give the user an up-to-date view of the current core state.
*/
class BetGeniusGUI : public QMainWindow
{
    Q_OBJECT
...
public:
    ...
    explicit BetGeniusGUI(interfaces::Node& node, const PlatformStyle *platformStyle, const NetworkStyle *networkStyle, QWidget *parent = nullptr);
    ~BetGeniusGUI();
    ...
    */
    ...
    /** Set the wallet model.
        The wallet model represents a betgenius wallet, and offers access to the list of transactions, address book and sending
        functionality.
    */
...
public Q_SLOTS:
    ...
    void incomingTransaction(const QString& date, BetGeniusUnit unit, const CAmount& amount, const QString& type, const QString& address, const QString& label, const QString& walletName);
#endif // ENABLE_WALLET
...
public Q_SLOTS:
    ...
    /** Load Partially Signed BetGenius Transaction from file or clipboard */
...
private Q_SLOTS:
    ...
    void updateDisplayUnit(BetGeniusUnit newUnits);
    /** Tells underlying optionsModel to update its current display unit. */
    void onMenuSelection(QAction* action);
};

#endif // BETGENIUS_QT_BETGENIUSGUI_H
