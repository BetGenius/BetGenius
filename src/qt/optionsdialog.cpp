      ...
      ui(new Ui::OptionsDialog)
{
    ...
    ui->betgeniusAtStartup->setVisible(false);
    ui->verticalLayout_Main->removeWidget(ui->betgeniusAtStartup);
    ...
    ui->betgeniusAtStartup->setToolTip(ui->betgeniusAtStartup->toolTip().arg(PACKAGE_NAME));
    ui->betgeniusAtStartup->setText(ui->betgeniusAtStartup->text().arg(PACKAGE_NAME));

    ui->openBetGeniusConfButton->setToolTip(ui->openBetGeniusConfButton->toolTip().arg(PACKAGE_NAME));
    ...
    ui->unit->setModel(new BetGeniusUnits(this));
...
{
    /* Main */
    mapper->addMapping(ui->betgeniusAtStartup, OptionsModel::StartAtStartup);
    ...
    mapper->addMapping(ui->m_enable_psbt_controls, OptionsModel::EnablePSBETGontrols);
...
void OptionsDialog::on_openBetGeniusConfButton_clicked()
{
