...
#ifndef BETGENIUS_QT_SENDCOINSENTRY_H
#define BETGENIUS_QT_SENDCOINSENTRY_H
...
/**
 * A single entry in the dialog for sending BetGenius.
 */
...
#endif // BETGENIUS_QT_SENDCOINSENTRY_H
