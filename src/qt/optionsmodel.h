...
#ifndef BETGENIUS_QT_OPTIONSMODEL_H
#define BETGENIUS_QT_OPTIONSMODEL_H
...
/** Interface from Qt to configuration data structure for BetGenius client.
...
public:
    ...
    BetGeniusUnit getDisplayUnit() const { return m_display_betgenius_unit; }
    QString getThirdPartyTxUrls() const { return strThirdPartyTxUrls; }
    QFont getFontForMoney() const;
    bool getCoinControlFeatures() const { return fCoinControlFeatures; }
    bool getSubFeeFromAmount() const { return m_sub_fee_from_amount; }
    bool getEnablePSBETGontrols() const { return m_enable_psbt_controls; }
...
private:
    ...
    QString language;
    BetGeniusUnit m_display_betgenius_unit;
...
Q_SIGNALS:
    void displayUnitChanged(BetGeniusUnit unit);
...
#endif // BETGENIUS_QT_OPTIONSMODEL_H
