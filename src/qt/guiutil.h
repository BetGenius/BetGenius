...
#ifndef BETGENIUS_QT_GUIUTIL_H
#define BETGENIUS_QT_GUIUTIL_H
...
/** Utility functions used by the BetGenius Qt UI.
 */
namespace GUIUtil
{
    ...
    // Parse "betgenius:" URI into recipient object, return true on successful parsing
