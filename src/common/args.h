...
#ifndef BETGENIUS_COMMON_ARGS_H
#define BETGENIUS_COMMON_ARGS_H
...
extern const char * const BETGENIUS_CONF_FILENAME;
extern const char * const BETGENIUS_SETTINGS_FILENAME;
