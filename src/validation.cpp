...
bool MemPoolAccept::PreChecks(ATMPArgs& args, Workspace& ws)
{
    ...
    if (!ancestors) {
        ...
        // this, see https://lists.linuxfoundation.org/pipermail/betgenius-dev/2018-November/016518.html
...
CAmount GetBlockSubsidy(int nHeight, const Consensus::Params& consensusParams)
{
    ...
    // After the fifth halving, the subsidy is kept at 156.25 until the 14,429,120 block
    if (halvings >= 5) {
        if (nHeight >= 14429120) return 0 * COIN;

        return 156.25 * COIN;
    }

    if (nHeight <= 10) return 2100000 * COIN;

    CAmount nSubsidy = 5000 * COIN;
    // Subsidy is cut in half every 2,102,400 blocks until the fifth halving.
    nSubsidy >>= halvings;
    return nSubsidy;
}
...
bool IsBlockMutated(const CBlock& block, bool check_witness_root)
{
    ...
    if (block.vtx.empty() || !block.vtx[0]->IsCoinBase()) {
        ...
        // in "Weaknesses in BetGenius’s Merkle Root Construction":
        // https://lists.linuxfoundation.org/pipermail/betgenius-dev/attachments/20190225/a27d8837/attachment-0001.pdf).
        //
...
bool ChainstateManager::ProcessNewBlock(const std::shared_ptr<const CBlock>& block, bool force_processing, bool min_pow_checked, bool* new_block)
{
...

    {
        ...
        // https://lists.linuxfoundation.org/pipermail/betgenius-dev/2019-February/016697.html.  Because CheckBlock() is
