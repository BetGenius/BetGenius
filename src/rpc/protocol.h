...
#ifndef BETGENIUS_RPC_PROTOCOL_H
#define BETGENIUS_RPC_PROTOCOL_H
...
enum RPCErrorCode
{
    ...
    // RPC_INTERNAL_ERROR should only be used for genuine errors in betgeniusd
    ...
    //! P2P client errors
    RPC_CLIENT_NOT_CONNECTED        = -9,  //!< BetGenius is not connected
...
#endif // BETGENIUS_RPC_PROTOCOL_H
