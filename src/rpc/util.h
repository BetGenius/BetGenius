...
#ifndef BETGENIUS_RPC_UTIL_H
#define BETGENIUS_RPC_UTIL_H
...
/**
 * Parse a json number or string, denoting BETG/kvB, into a CFeeRate (sat/kvB).
 * Reject negative values or rates larger than 1BETG/kvB.
 */
