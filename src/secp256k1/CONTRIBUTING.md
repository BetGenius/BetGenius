...
The library primarily serves the needs of the BetGenius Core project but provides additional functionality for the benefit of the wider BetGenius ecosystem.
...
* **Relevance Arguments:**
    The relevance of the new functionality for the BetGenius ecosystem should be argued by outlining clear use cases.
...
The Contributor Workflow & Peer Review in libsecp256k1 are similar to BetGenius Core's workflow and review processes described in its [CONTRIBUTING.md](https://github.com/BetGenius/BetGenius/blob/master/CONTRIBUTING.md).
