...
#ifndef BETGENIUS_UTIL_MESSAGE_H
#define BETGENIUS_UTIL_MESSAGE_H
 ...
 * @param[in] address Signer's betgenius address, it must refer to a public key.
...
#endif // BETGENIUS_UTIL_MESSAGE_H
