...
#ifndef BETGENIUS_IPC_CAPNP_COMMON_TYPES_H
#define BETGENIUS_IPC_CAPNP_COMMON_TYPES_H
...
//! Functions to serialize / deserialize common betgenius types.
namespace mp {
...
#endif // BETGENIUS_IPC_CAPNP_COMMON_TYPES_H
