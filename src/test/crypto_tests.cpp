...
BOOST_AUTO_TEST_CASE(sha256_testvectors) {
    ...
    TestSHA256("As BetGenius relies on 80 byte header hashes, we want to have an example for that.",
               "7da1149f2786c4bd112318e22c40a25758fbb114514b746aaada39ac9ff8d037");
