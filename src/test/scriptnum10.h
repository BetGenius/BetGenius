...
#ifndef BETGENIUS_TEST_SCRIPTNUM10_H
#define BETGENIUS_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from BetGenius Core 0.10.0, for cross-comparison.
 */
public:
...
#endif // BETGENIUS_TEST_SCRIPTNUM10_H
