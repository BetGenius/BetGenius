...
{
    BOOST_CHECK(TestSplitHost("www.betgenius.cc", "www.betgenius.cc", 0));
    BOOST_CHECK(TestSplitHost("[www.betgenius.cc]", "www.betgenius.cc", 0));
    BOOST_CHECK(TestSplitHost("www.betgenius.cc:80", "www.betgenius.cc", 80));
    BOOST_CHECK(TestSplitHost("[www.betgenius.cc]:80", "www.betgenius.cc", 80));
    BOOST_CHECK(TestSplitHost("127.0.0.1", "127.0.0.1", 0));
    BOOST_CHECK(TestSplitHost("127.0.0.1:5870", "127.0.0.1", 5870));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]", "127.0.0.1", 0));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]:5870", "127.0.0.1", 5870));
    BOOST_CHECK(TestSplitHost("::ffff:127.0.0.1", "::ffff:127.0.0.1", 0));
    BOOST_CHECK(TestSplitHost("[::ffff:127.0.0.1]:5870", "::ffff:127.0.0.1", 5870));
    BOOST_CHECK(TestSplitHost("[::]:5870", "::", 5870));
    BOOST_CHECK(TestSplitHost("::5870", "::5870", 0));
    BOOST_CHECK(TestSplitHost(":5870", "", 5870));
    BOOST_CHECK(TestSplitHost("[]:5870", "", 5870));
    ...
    BOOST_CHECK(TestSplitHost("www.betgenius.cc:65536", "www.betgenius.cc:65536", 0, false));
    BOOST_CHECK(TestSplitHost("www.betgenius.cc:0", "www.betgenius.cc", 0, false));
    BOOST_CHECK(TestSplitHost("www.betgenius.cc:", "www.betgenius.cc:", 0, false));
}
...
BOOST_AUTO_TEST_CASE(netbase_lookupnumeric)
{
    ...
    BOOST_CHECK(TestParse("127.0.0.1:5870", "127.0.0.1:5870"));
    BOOST_CHECK(TestParse("::ffff:127.0.0.1", "127.0.0.1:65535"));
    BOOST_CHECK(TestParse("::", "[::]:65535"));
    BOOST_CHECK(TestParse("[::]:5870", "[::]:5870"));
    BOOST_CHECK(TestParse("[127.0.0.1]", "127.0.0.1:65535"));
