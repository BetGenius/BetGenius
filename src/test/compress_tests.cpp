...
// amounts 1 .. 10000
#define NUM_MULTIPLES_1BETG 10000

// amounts 50 .. 21000000000
#define NUM_MULTIPLES_50BETG 420000
...
BOOST_AUTO_TEST_CASE(compress_amounts)
{
    ...
    BOOST_CHECK(TestPair(    5000*COIN,      0x1f4));
    ...
    for (uint64_t i = 1; i <= NUM_MULTIPLES_1BETG; i++)
        BOOST_CHECK(TestEncode(i * COIN));

    for (uint64_t i = 1; i <= NUM_MULTIPLES_50BETG; i++)
