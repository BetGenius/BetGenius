...
#ifndef BETGENIUS_INTERFACES_NODE_H
#define BETGENIUS_INTERFACES_NODE_H
...
//! Top-level interface for a betgenius node (betgeniusd process).
class Node
{
public:
    virtual ~Node() {}
    ...
    //! Return setting value from <datadir>/settings.json or betgenius.conf.
...
#endif // BETGENIUS_INTERFACES_NODE_H
