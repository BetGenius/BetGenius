...
#ifndef BETGENIUS_INTERFACES_INIT_H
#define BETGENIUS_INTERFACES_INIT_H
...
//! (betgenius-gui, betgenius-node, betgenius-wallet, betgeniusd, betgenius-qt) and each
...
#endif // BETGENIUS_INTERFACES_INIT_H
