...
// Copyright 2015 BetGenius Core Developers
// Distributed under the MIT software license, see the accompanying
// file COPYING or https://opensource.org/licenses/mit-license.php.

#ifndef BETGENIUS_UNIVALUE_INCLUDE_UNIVALUE_H
#define BETGENIUS_UNIVALUE_INCLUDE_UNIVALUE_H
...
#endif // BETGENIUS_UNIVALUE_INCLUDE_UNIVALUE_H
