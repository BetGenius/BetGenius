...
#ifndef BETGENIUS_SCRIPT_SCRIPT_H
#define BETGENIUS_SCRIPT_SCRIPT_H
...
public:
    ...
    /**
     * Pre-version-0.6, BetGenius always counted CHECKMULTISIGs
...
#endif // BETGENIUS_SCRIPT_SCRIPT_H
