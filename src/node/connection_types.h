...
#ifndef BETGENIUS_NODE_CONNECTION_TYPES_H
#define BETGENIUS_NODE_CONNECTION_TYPES_H
 ...
 * src/qt/guiutil.cpp and src/betgenius-cli.cpp::NetinfoRequestHandler. */
enum class ConnectionType {
     ...
     * Note that in the literature ("Eclipse Attacks on BetGenius’s Peer-to-Peer Network")
...
#endif // BETGENIUS_NODE_CONNECTION_TYPES_H
