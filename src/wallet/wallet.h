...
#ifndef BETGENIUS_WALLET_WALLET_H
#define BETGENIUS_WALLET_WALLET_H
...
public:
     ...
     * betgenius-wallet tool code or by wallet migration code. If this is called
...
#endif // BETGENIUS_WALLET_WALLET_H
