...
#ifndef BETGENIUS_WALLET_SCRIPTPUBKEYMAN_H
#define BETGENIUS_WALLET_SCRIPTPUBKEYMAN_H
 ...
 * change.
 *
 * The BetGenius Core wallet was originally a collection of unrelated private
...
#endif // BETGENIUS_WALLET_SCRIPTPUBKEYMAN_H
