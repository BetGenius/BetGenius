...
#ifndef BETGENIUS_WALLET_EXTERNAL_SIGNER_SCRIPTPUBKEYMAN_H
#define BETGENIUS_WALLET_EXTERNAL_SIGNER_SCRIPTPUBKEYMAN_H
...
#endif // BETGENIUS_WALLET_EXTERNAL_SIGNER_SCRIPTPUBKEYMAN_H
