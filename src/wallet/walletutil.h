...
#ifndef BETGENIUS_WALLET_WALLETUTIL_H
#define BETGENIUS_WALLET_WALLETUTIL_H
...
enum WalletFlags : uint64_t {
    ...
    //! betgenius from opening the wallet, thinking it was newly created, and
...
#endif // BETGENIUS_WALLET_WALLETUTIL_H
