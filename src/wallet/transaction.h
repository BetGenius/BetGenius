...
#ifndef BETGENIUS_WALLET_TRANSACTION_H
#define BETGENIUS_WALLET_TRANSACTION_H
...
public:
     ...
     * on this betgenius node, and set to 0 for transactions that were created
...
#endif // BETGENIUS_WALLET_TRANSACTION_H
