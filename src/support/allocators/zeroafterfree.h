...
#ifndef BETGENIUS_SUPPORT_ALLOCATORS_ZEROAFTERFREE_H
#define BETGENIUS_SUPPORT_ALLOCATORS_ZEROAFTERFREE_H
...
#endif // BETGENIUS_SUPPORT_ALLOCATORS_ZEROAFTERFREE_H
