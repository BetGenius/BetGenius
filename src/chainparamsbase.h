...
#ifndef BETGENIUS_CHAINPARAMSBASE_H
#define BETGENIUS_CHAINPARAMSBASE_H
...
/**
 * CBaseChainParams defines the base parameters (shared between betgenius-cli and betgeniusd)
 * of a given instance of the BetGenius system.
 */
...
#endif // BETGENIUS_CHAINPARAMSBASE_H
