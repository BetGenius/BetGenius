...
#ifndef BETGENIUS_KERNEL_DISCONNECTED_TRANSACTIONS_H
#define BETGENIUS_KERNEL_DISCONNECTED_TRANSACTIONS_H
...
#endif // BETGENIUS_KERNEL_DISCONNECTED_TRANSACTIONS_H
