...
#ifndef BETGENIUS_ARITH_UINT256_H
#define BETGENIUS_ARITH_UINT256_H
...
public:
     ...
     *
     * BetGenius only uses this "compact" format for encoding difficulty
...
#endif // BETGENIUS_ARITH_UINT256_H
