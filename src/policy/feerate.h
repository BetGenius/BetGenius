...
#ifndef BETGENIUS_POLICY_FEERATE_H
#define BETGENIUS_POLICY_FEERATE_H
...
const std::string CURRENCY_UNIT = "BETG"; // One formatted unit
...
enum class FeeEstimateMode {
    ...
    BETG_KVB,      //!< Use BETG/kvB fee rate unit
...
public:
    ...
    std::string ToString(const FeeEstimateMode& fee_estimate_mode = FeeEstimateMode::BETG_KVB) const;
...
#endif // BETGENIUS_POLICY_FEERATE_H
