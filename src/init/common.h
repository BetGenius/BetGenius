...
//! @file
//! @brief Common init functions shared by betgenius-node, betgenius-wallet, etc.

#ifndef BETGENIUS_INIT_COMMON_H
#define BETGENIUS_INIT_COMMON_H
