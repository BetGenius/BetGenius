...
EXPECTED_HOLDER_NAMES = [
    r"Satoshi Nakamoto",
    r"The BetGenius Core developers",
    r"BitPay Inc\.",
...
Arguments:
    <base_directory> - The base directory of a betgenius source code repository.
...
YEAR = "20[0-9][0-9]"
YEAR_RANGE = '(%s)(-%s)?' % (YEAR, YEAR)
HOLDER = 'The BetGenius Core developers'
...
Arguments:
    <file> - A source file in the betgenius repository.
"""
...
USAGE = """
copyright_header.py - utilities for managing copyright headers of 'The BetGenius
