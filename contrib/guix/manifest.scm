...
(define* (make-betgenius-cross-toolchain target
                                       #:key
...
desirable for building BetGenius Core release binaries."
...
;; failure; see https://github.com/BetGenius/BetGenius/pull/27296.
  ...
  (let ((target (getenv "HOST")))
    (cond ((string-suffix? "-mingw32" target)
          ...
          ((string-contains target "-linux-")
           (list (make-betgenius-cross-toolchain target)))
