...
complete --command betgenius-qt --no-files

# Extract options
function __fish_betgeniusqt_get_options
...
complete \
    --command betgenius-qt \
    --arguments "(__fish_betgeniusqt_get_options)"
# Enable file completions only if the commandline now contains a `*.=` style option
complete -c betgenius-qt \
...
complete \
    --command betgenius-qt \
    --arguments "(__fish_betgeniusqt_get_options --nofiles)"
