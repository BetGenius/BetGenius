...
complete --command betgeniusd --no-files

# Extract options
function __fish_betgeniusd_get_options
...
complete \
    --command betgeniusd \
    --arguments "(__fish_betgeniusd_get_options --nofiles)"
