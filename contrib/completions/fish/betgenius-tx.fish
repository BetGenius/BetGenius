...
# Extract options
function __fish_betgenius_tx_get_options
...
# Extract commands
function __fish_betgenius_tx_get_commands
...
# Add options
complete \
    --command betgenius-tx \
    --condition "not __fish_betgenius_seen_cmd (__fish_betgenius_tx_get_commands --commandsonly)" \
    --arguments "(__fish_betgenius_tx_get_options)" \
    --no-files

# Add commands
complete \
    --command betgenius-tx \
    --arguments "(__fish_betgenius_tx_get_commands)" \
    --no-files
