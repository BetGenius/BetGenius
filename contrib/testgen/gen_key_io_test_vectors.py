...
bech32_templates = [
  ...
  ('rbtg',  0, 20, (False, 'regtest', None, True), Encoding.BECH32,  p2wpkh_prefix),
  ('rbtg',  0, 32, (False, 'regtest', None, True), Encoding.BECH32,  p2wsh_prefix),
  ('rbtg',  1, 32, (False, 'regtest', None, True), Encoding.BECH32M, p2tr_prefix),
  ('rbtg', 16, 40, (False, 'regtest', None, True), Encoding.BECH32M, (OP_16, 40))
]
# templates for invalid bech32 sequences
bech32_ng_templates = [
  # hrp, version, witprog_size, encoding, invalid_bech32, invalid_checksum, invalid_char
  ('tb',    0, 20, Encoding.BECH32,  False, False, False),
  ('tg',    1, 32, Encoding.BECH32M, False, False, False),
  ('tbtg',   17, 32, Encoding.BECH32M, False, False, False),
  ('rbtg',  3,  1, Encoding.BECH32M, False, False, False),
  ('btg',   15, 41, Encoding.BECH32M, False, False, False),
  ('tbtg',    0, 16, Encoding.BECH32,  False, False, False),
  ('rbtg',  0, 32, Encoding.BECH32,  True,  False, False),
  ('btg',    0, 16, Encoding.BECH32,  True,  False, False),
  ('tbtg',    0, 32, Encoding.BECH32,  False, True,  False),
  ('rbtg',  0, 20, Encoding.BECH32,  False, False, True),
  ('btg',    0, 20, Encoding.BECH32M, False, False, False),
  ('tbtg',    0, 32, Encoding.BECH32M, False, False, False),
  ('rbtg',  0, 20, Encoding.BECH32M, False, False, False),
  ('btg',    1, 32, Encoding.BECH32,  False, False, False),
  ('tbtg',    2, 16, Encoding.BECH32,  False, False, False),
  ('rbtg', 16, 20, Encoding.BECH32,  False, False, False),
]
