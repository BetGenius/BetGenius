...
"""Example logging BetGenius Core utxo set cache flushes utilizing
    the utxocache:flush tracepoint."""

# USAGE:  ./contrib/tracing/log_utxocache_flush.py path/to/betgeniusd
...
def main(betgeniusd_path):
    ...
    b = BPF(text=program, usdt_contexts=[betgeniusd_with_usdts])
