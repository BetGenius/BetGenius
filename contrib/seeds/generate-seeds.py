...
def main():
    ...
    g = sys.stdout
    indir = sys.argv[1]
    g.write('#ifndef BETGENIUS_CHAINPARAMSSEEDS_H\n')
    g.write('#define BETGENIUS_CHAINPARAMSSEEDS_H\n')
    g.write('/**\n')
    g.write(' * List of fixed seed nodes for the betgenius network\n')
    ...
    g.write('#endif // BETGENIUS_CHAINPARAMSSEEDS_H\n')
